...
# edit_plate4_standards.pl by Rohan Maddamsetti.
# This script makes a copy of the 091130_VeraCode_A-1_assay.tab file
# entitled 110208_VeraCode_A-1_assay4.tab. The only difference is that
# the Sample ID columns is changed to reflect the Sample ID columns in the
# data input file, "Plate_4_FinalReport_no_header.txt".

use strict;

open PROPER_HEADERS, "<input/Plate_4_FinalReport_no_header.txt" or die "cannot open file for input $!";
...
open NEW_STANDARDS, ">input/110208_VeraCode_A-1_assay4.tab" or die "cannot open file for output: $!";
